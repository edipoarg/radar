      ...
      definitions: [
        {
          paragraphs: [
            ...
            "Algo similar sucede en el caso de la clasificación de los hechos registrados por la base, que obedece a una tipología de casos establecida en función de ataques geocalizables.",
